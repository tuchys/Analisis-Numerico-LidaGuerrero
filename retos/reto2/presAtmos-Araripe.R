...
c<-c(1:tam)
plot(1:length(datosOriginales),datosOriginales,type = "l",xlab = "numeracion de dias",ylab = "Presion atmosferica relativa",main = "Presion atmosferica Splinefun")
...
plot(1:length(datosOriginales),datosOriginales,type = "l",xlab = "numeracion de dias",ylab = "Presion atmosferica relativa",main = "Presion atmosferica lineal")
